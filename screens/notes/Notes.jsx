...
const Notes = () => {
    ...
    const { notes, getNotes, addNote } = useContext(notesContext)
            ...
            <Modal animationType='slide' visible={visible}>
                <View style={{ flex: 1, marginTop: SIZES.statusBarHeight }}>
                    ...
                    <View style={{ marginTop: 80, width: SIZES.width * 0.95, alignSelf: 'center' }}>
                        <InputTextField multiline={true} placeholder='Type your note' value={noteData} onChangeText={text => setNoteData(text)} />
                    </View>
